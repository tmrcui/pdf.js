...
class SecondaryToolbar {
  ...
  constructor(options, eventBus) {
    ...
    const buttons = [
      ...
      { element: options.saveToImageButton, eventName: "savetoimage", close: true },
      { element: options.openLinkButton, eventName: "toggleopenlink", close: true },
      { element: options.closeOpenLinkButton, eventName: "toggleopenlink", close: true },
