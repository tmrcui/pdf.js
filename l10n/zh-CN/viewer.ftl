...
pdfjs-open-link-button =
    .title = 打开链接
    .placeholder = 请输入PDF文件链接
pdfjs-open-link-button-label = 打开链接
pdfjs-close-open-link-button-label = 关闭
...
pdfjs-save-to-image-button = 
    .title = 保存为图片
pdfjs-save-to-image-button-label = 保存为图片
